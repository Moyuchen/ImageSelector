...
public class MultiImageSelector {
    ...
    public static final String EXTRA_RESULTS = MultiImageSelectorActivity.EXTRA_RESULTS;

    private boolean mShowCamera = true;
    private int mMaxCount = 9;
    private int mMode = MultiImageSelectorActivity.MODE_MULTI;
    private ArrayList<String> mOriginData;
    private ArrayList<SelectBean> returnList;//已选择的图片
    ...
    public MultiImageSelector selected(ArrayList<SelectBean> selectedBeans) {
        returnList = selectedBeans;
        return this;
    }
    ...
    private Intent createIntent(Context context) {
        ...
        if ( null != returnList) {
            intent.putParcelableArrayListExtra(MultiImageSelectorActivity.EXTRA_DEFAULT_SELECTED_LIST_RETURN,returnList);
        }
